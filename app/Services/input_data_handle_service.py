...
class InputDataHandleService:
    ...
    async def process_file(
        ...
        # Step 3: Extract text
        # if(settings.CHUNKING_STRATEGY== "Page_Based"):
        ...
        if settings.CHUNKING_STRATEGY == "Page_Based":
            chunks = self.chunk_text_by_page(text, metadata=base_metadata)
        else:
        ...
        logger.info(
            ...
            f"file_id={file_id}, chunks={len(chunks)}, pages={_pages}, size={len(file_content)} bytes"
        )
