    ...
    try:
        ...
        await file_metadata_provider.add_file(
            ...
            metadata={
                ...
                "chunk_sizes": settings.CHUNK_SIZE if settings.CHUNKING_STRATEGY == "recursive" else None
            }
        )
        ...
        if overview_service:
            try:
                ...
                logger.warning(f"Failed to generate overview for {file_id}: {overview_error}")
